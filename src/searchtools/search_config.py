...
class SearchToolsConfig(BaseModel):
    ...
    # Rerank settings
    enable_rerank: bool = Field(default=True, description="Enable intelligent reranking")
    rerank_relevance_weight: float = Field(default=0.40, description="Relevance score weight")
    rerank_authority_weight: float = Field(default=0.30, description="Authority score weight")
    rerank_recency_weight: float = Field(default=0.20, description="Recency score weight")
    rerank_quality_weight: float = Field(default=0.10, description="Quality score weight")
